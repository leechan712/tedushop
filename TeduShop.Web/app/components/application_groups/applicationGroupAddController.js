(function (app) {
    ...
    applicationGroupAddController.$inject = ['apiService', '$scope', 'notificationService', '$location', 'commonService'];

    function applicationGroupAddController(apiService, $scope, notificationService, $location, commonService) {
        $scope.group = {
            ID: 0,
            Roles: []
        }
